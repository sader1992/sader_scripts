...
Q_easy:
	if (BaseLevel < .qs_elevel){
		mes "Your level is too low .";
		mes "Minimum level for this quest is "+.qs_elevel+".";
		close;
	}
...
Q_normal:
	if (BaseLevel < .qs_nlevel){
		mes "Your level is too low .";
		mes "Minimum level for this quest is "+.qs_nlevel+".";
		close;
	}
...
Q_hard:
	if (BaseLevel < .qs_hlevel){
		mes "Your level is too low .";
		mes "Minimum level for this quest is "+.qs_hlevel+".";
		close;
	}
...
Q_indeterminate:
	if (BaseLevel < .qs_ilevel){
		mes "Your level is too low .";
		mes "Minimum level for this quest is "+.qs_ilevel+".";
		close;
	}
